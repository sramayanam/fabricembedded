...
async function getEmbedParamsForSingleReport(workspaceId, reportId, additionalDatasetId) {
    ...
    console.log("GET Report Info Rest Call::::::::::::");
    console.log("Report In Group API:::::" + reportInGroupApi);
    console.log("Embedding Header:::::" + JSON.stringify(headers));
    ...
    console.log("Result From Report Details" + JSON.stringify(resultJson));
    console.log("#############################################################################################################");
...
async function getEmbedTokenForSingleReportSingleWorkspace(reportId, datasetIds, targetWorkspaceId) {
    ...
    const headers = await getRequestHeader();
    console.log("Inside getEmbedTokenForSingleReportSingleWorkspace::::::");
    console.log("Embed Token API:::::" + embedTokenApi);
    console.log("Embedding Header:::::" + JSON.stringify(headers));
    console.log("Embedding Body:::::" + JSON.stringify(formData));
